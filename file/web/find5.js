...
function findit()
{
	...
	else
	{
		...
		{
			find_msg.innerHTML = "&nbsp;<b>Tidak ditemukan</b>"; // ver 5.1 - 10/17/2014 - changed from "Not Found"
			find_pointer = -1;
		}
	}
	findwindow.style.visibility = 'visible';
...
function findnext()
{
	...
	find_msg.innerHTML = display_find+" dari "+highlights.length;
...
{
   	var info = "To add Cool JavaScript Find to your website go to: https://www.webpulsa.id"; // Version 5.4e
	...
	+ ' onclick="show();"><span style="position:fixed;top:2px;right:2px;background:#fff;border: 2px #ff0000 solid;border-radius:10px;padding:5px;color:#000;">Cari</span></a>');
    ...
    findwindow.style.top = '2px';
	findwindow.style.left = '20px';
	findwindow.style.right = '30px';
	...
	//+ ';float: center' // Version 5.4e
	+ ';" onmouseover="over=1;" onmouseout="over=0;">'
	+ 'PENCARIAN PRODUK</div>';
...
// This part creates the instructions and the "find" button
	...
	+ ' style="width:80%"' // Version 5.4e
	+ ' onchange="resettext();" placeholder="Ketik disini lalu tekan enter.!!">'
	...
	if (enable_site_search) { // Version 5.4
		string += '<br /><label style="margin-left:-9999999999999px"><input type="radio" name="search_type" value="page" checked>Page</label>'+
